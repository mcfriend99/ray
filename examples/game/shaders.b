...
var model = ui.LoadModel(os.join_paths(os.dir_name(__file__), 'resources', 'models', 'church.obj'))
var texture = ui.LoadTexture(os.join_paths(os.dir_name(__file__), 'resources', 'models', 'church_diffuse.png'))
